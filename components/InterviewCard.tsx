...
const InterviewCard = ({
  ...
  // const imageIndex =
  //   InterviewId.split("").reduce((total, character) => total + character.charCodeAt(0), 0) %
  //   interviewImage.length;
  //console.log("InInterviewId", InterviewId);
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div className="mt-auto flex items-end justify-between gap-4 pt-6">
          ...
          >
            <Link
              href={feedback ? `/interview/id/${id}/feedback` : `/interview/id/${id}`}
            >
